...
- تعمل على اللابتوب وعلى iPad (عرض 768).
...
**الإدارة**: `/admin` → كلمة المرور → إدارة المنتجات/التصنيفات/الطابعات/العملات، متابعة الطباعة، والتقارير.
...
| `npm run test:ui` | Playwright: نفس السيناريو عبر واجهة نقطة البيع + لوحة التحكم كاملة (لابتوب + iPad) | ✅ 0 أخطاء · 31/31 |
